...
class AuthorController extends AbstractController
{
    ...
    public function getAllAuthors(AuthorRepository $authorRepository, SerializerInterface $serializer, TagAwareCacheInterface $cache, Request $request, VersioningService $versioningService): JsonResponse
    {
